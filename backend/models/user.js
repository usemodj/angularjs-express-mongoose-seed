...
UserSchema = new Schema({
    ...
    current_sign_in_ip: { type: String, default: ''},
    current_sign_in_at: { type: Date},
    last_sign_in_ip: { type: String, default: ''},
...
UserSchema.statics = {
  ...
  load: function (options, cb) {
    options.select = options.select || 'email username active role';
    this.findOne(options.criteria)
      .select(options.select)
      .exec(cb);
  },
  findByPasswordToken: function(user, callback) {
    this.findOne({
        email: user.email,
